...
describe('WorkflowEditor', () => {
  ...
  describe('action management', () => {
    ...
    it('should append action when key button is clicked', () => {
      ...
      expect(component.executeActions)
          .toHaveBeenCalledWith([new KeyAction([Key.UP])]);
      ...
      expect(component.executeActions)
          .toHaveBeenCalledWith([new KeyAction([Key.RIGHT])]);
      ...
      expect(component.executeActions)
          .toHaveBeenCalledWith([new KeyAction([Key.DOWN])]);
    });
  ...
  describe('action execution', () => {
    ...
    it('should stop execution when stop button is clicked', fakeAsync(() => {
         ...
         expect(() => { tick(); }).toThrowError(/Execution cancelled/);
         expect(component.executing).toEqual(undefined);
