...
// @ts-ignore(go/unfork-jasmine-typings): Argument of type 'Observable<{}>' is not assignable to parameter of type 'Observable<NotesResponse>'.
    tfcClient.batchGetDeviceNotes.and.returnValue(observableOf({}));
//TODO: Wait until b/208710526 is fixed, then remove this autogenerated error suppression.
// @ts-ignore(go/unfork-jasmine-typings): Argument of type 'Observable<{}>' is not assignable to parameter of type 'Observable<LabDeviceInfoHistoryList>'.
