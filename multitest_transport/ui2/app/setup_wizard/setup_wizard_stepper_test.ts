...
// @ts-ignore(go/unfork-jasmine-typings): Argument of type 'Observable<{ build_channels: { id: string; name: string; provider_name: string; auth_state: AuthorizationState; auth_methods: never[]; build_item_path_type: BuildItemPathType; }; }>' is not assignable to parameter of type 'Observable<BuildChannelList>'.
