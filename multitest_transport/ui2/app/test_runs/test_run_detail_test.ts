...
// @ts-ignore(go/unfork-jasmine-typings): Argument of type 'Observable<DeviceInfo[]>' is not assignable to parameter of type 'Observable<DeviceInfosResponse>'.
...
//TODO: Wait until b/208710526 is fixed, then remove this autogenerated error suppression.
// @ts-ignore(go/unfork-jasmine-typings): Argument of type 'Observable<{ id: string; name: string; phases: TestRunPhase.MANUAL[]; }[]>' is not assignable to parameter of type 'Observable<TestRunAction[]>'.
       testRunActionClient.list.and.returnValue(observableOf(
  ...
  it('opens the test run action picker dialog and executes successfully',
     inject([MatLegacyDialog], (dialog: MatLegacyDialog) => {
       ...
       testRunDetailFixture.detectChanges();
//TODO: Wait until b/208710526 is fixed, then remove this autogenerated error suppression.
// @ts-ignore(go/unfork-jasmine-typings): Argument of type '{ componentInstance: { confirm: Observable<{ action_id: string; }[]>; }; }' is not assignable to parameter of type 'MatDialogRef<unknown, unknown>'.
