...
// @ts-ignore(go/unfork-jasmine-typings): Argument of type 'Observable<{ deviceInfos: { hostname: string; }[]; }>' is not assignable to parameter of type 'Observable<LabDeviceInfosResponse>'.
